...
<%@ taglib uri="http://www.ibm.com/xmlns/prod/websphere/portal/v8.0/portal-core" prefix="portal-core" %>
<%@ taglib uri="http://www.ibm.com/xmlns/prod/websphere/portal/v8.0/portal-logic" prefix="portal-logic" %>
